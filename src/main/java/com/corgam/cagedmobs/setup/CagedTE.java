...
public class CagedTE {
    ...
    // CAGES
    public final static RegistryObject<TileEntityType<MobCageTE>> MOB_CAGE = TE_REG.register("mobcage", () -> TileEntityType.Builder.of(MobCageTE::new, CagedBlocks.MOB_CAGE.get(), CagedBlocks.HOPPING_MOB_CAGE.get()).build(null));
}
