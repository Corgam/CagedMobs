...
import com.corgam.cagedmobs.blocks.TestBlock;
...
public class CagedBlocks {
    ...
    public final static RegistryObject<Block> TEST_BLOCK = BLOCKS_REG.register("testblock", () -> new TestBlock(Block.Properties.of().mapColor(MapColor.METAL).sound(SoundType.METAL).strength(5.0F, 6.0F).requiresCorrectToolForDrops()));
    // BLOCKS
