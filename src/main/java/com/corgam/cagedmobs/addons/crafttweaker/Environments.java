...
public class Environments implements IRecipeManager {
    ...
    @ZenCodeType.Method
    public CTEnvironment create (String id, IIngredient item, MCBlockState renderState, float growModifier, String category) {
        return this.create(id,item,renderState,growModifier, new String[]{category});
    }

    @ZenCodeType.Method
    public CTEnvironment create (String id, IIngredient item, MCBlockState renderState, float growModifier, String[] categories) {
